...
par(mfrow = c(2, 2))
plot(transdata2$Date, transdata2$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")

plot(transdata2$Date, transdata2$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(transdata2$Date, transdata2$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
